...
export const BASE_IP = process.env.BASE_IP || `http://194.67.113.110`;
export const BASE_STEAM_API_URL =
  process.env.BASE_STEAM_API_URL || 'https://api.steampowered.com/';
export const BASE_RETURN_URL =
  process.env.BASE_RETURN_URL || `${BASE_IP}:${PORT}/auth/steam/return`;
export const BASE_REALM = process.env.BASE_REALM || `${BASE_IP}:${PORT}/`;
